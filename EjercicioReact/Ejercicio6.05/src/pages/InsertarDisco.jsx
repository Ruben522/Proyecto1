...
const FormularioDisco = () => {
	const { disco, actualizarDato, guardarDisco } = useDiscos();
					...
					<form id="formu" name="formu">
						...
						<div className="generos" id="generos">
							...
							<input
								...
								name="generos"
								value="rock"
								checked={disco.generos.includes("rock")}
								onChange={(evento) => {
							...
							<input
								...
								name="generos"
								value="jazz"
								checked={disco.generos.includes("jazz")}
								onChange={(evento) => {
									actualizarGenerosCheck(evento);
								}}
							/>
							...
							<input
								...
								name="generos"
								value="funk"
								checked={disco.generos.includes("funk")}
								onChange={(evento) => {
									actualizarGenerosCheck(evento);
								}}
							/>
							...
							<input
								...
								name="generos"
								value="hip-hop"
								checked={disco.generos.includes("hip-hop")}
								onChange={(evento) => {
									actualizarGenerosCheck(evento);
								}}
							/>
							...
							<input
								...
								name="generos"
								value="house"
								checked={disco.generos.includes("house")}
								onChange={(evento) => {
									actualizarGenerosCheck(evento);
								}}
							/>
