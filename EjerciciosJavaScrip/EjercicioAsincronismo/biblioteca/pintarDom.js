...
const estructuraPelicula = (datos) => {
	return `
        <div class="pelicula-informacion">
                ...
                <p><strong>Fecha: </strong>${transformarFechaCastellano(new Date(datos.release_date))}</p>
        </div>
    `;
};
...
export { mostrarNombrePeliculas, mostrarPelicula, mostrarErrores, limpiarErrores };